...
local DEFAULT_CFG = {
    ...
    weapons = {
        wp0000 = { enabled = true, label = "Matilda" },
        wp0100 = { enabled = true, label = "M19" },
        wp0200 = { enabled = true, label = "JMB Hp3" },
        wp0300 = { enabled = false, needs_manual_cylinder_reload = false, no_slide_rack_required = true, label = "Quickdraw Army" },
        wp0400 = { enabled = false, label = "Glock 17" },
        wp0600 = { enabled = false, label = "MUP" },
        wp0700 = { enabled = false, label = "Broom Hc" },
        wp0800 = { enabled = false, label = "SLS 60" },
        ...
        wp2000 = { enabled = false, label = "MQ 11" },
        wp2200 = { enabled = false, label = "LE 5" },
        wp3000 = { enabled = false, label = "Lightning Hawk" },
...
local function is_vr_right_trigger_down()
    if not vrmod then return false end
    if not trigger_action_cache then
...
local function draw_reload_ui()
    ...
    imgui.text_colored("Manual Reload:", UI_ACCENT)
