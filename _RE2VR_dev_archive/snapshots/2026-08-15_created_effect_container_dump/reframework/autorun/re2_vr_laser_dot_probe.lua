...
local function log_stage(stage)
    ...
    log.info(string.format(
        "[laser_dot_probe] frame=%d stage=%-24s spine_on=%-5s spine_timing=%-7s src=%-28s tip=%s  muzzle_pos=%s  muzzle_fwd=%s  cam_fwd=%s  wrist_fwd=%s  vfx3_fwd=%s  dev_deg=%s  dev_deg_vs_cam=%s  dev_deg_wrist_vs_cam=%s  dev_deg_tip_vs_cam=%s  dev_deg_vfx3_vs_cam=%s",
