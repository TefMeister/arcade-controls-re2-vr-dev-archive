...
re.on_draw_ui(function()
    ...
    local adc, adv = imgui.checkbox("Auto-dump ALL THREE (tree + LaserSightController + PointerEffect) on next aim start (safer -- no button press needed while holding RG)", state.auto_dump_hierarchy_on_aim)
