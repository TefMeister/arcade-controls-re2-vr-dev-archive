...
re.on_draw_ui(function()
    ...
    local adc, adv = imgui.checkbox("Auto-dump BOTH (tree + LaserSightController) on next aim start (safer -- no button press needed while holding RG)", state.auto_dump_hierarchy_on_aim)
