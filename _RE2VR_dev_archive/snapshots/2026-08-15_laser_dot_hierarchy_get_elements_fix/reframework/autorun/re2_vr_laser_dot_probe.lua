...
re.on_draw_ui(function()
    ...
    local adc, adv = imgui.checkbox("Auto-dump on next aim start (safer -- no button press needed while holding RG)", state.auto_dump_hierarchy_on_aim)
    ...
    imgui.text_colored(
        ...
        0xFF88CCFF)
    imgui.text_colored(
        "2026-08-15: original investigation only checked DIRECT children -- this walks the WHOLE tree.",
        0xFF88CCFF)
