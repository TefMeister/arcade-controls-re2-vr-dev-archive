...
-- 2026-08-14: CONFIRMED real method via live dump -- via.Application has
-- get_GlobalSpeed/set_GlobalSpeed. via.SceneManager confirmed to have none
-- of these at all. get_GlobalSpeed is now first in the list (real, not
-- guessed); the rest kept as fallback in case it turns out not to be the
-- actual pause mechanism.
local CANDIDATE_GETTERS = { "get_GlobalSpeed", "get_TimeScale", "get_CurrentTimeScale", "get_Speed", "get_SpeedRate" }
