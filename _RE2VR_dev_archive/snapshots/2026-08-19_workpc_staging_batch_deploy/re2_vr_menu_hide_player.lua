...
-- via.render.Mesh under the player while GUIMaster reports the inventory or map
-- open (get_IsOpenInventory / get_IsOpenMap -- both proven detectors from
...
re.on_draw_ui(function()
    ...
    imgui.text("While the inventory/map is open, the player + weapon are fully")
